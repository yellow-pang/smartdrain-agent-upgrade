...
2026-06-18 기준 MVP API 명세는 `frontend/docs/api-spec/2026-06-18_mvp_api_spec_v1.md`에서 관리한다. 최초 v1 초안을 작성한 뒤 백엔드 API 기준 통합 수정본을 반영해 v2로 업그레이드했으며, 이후 endpoint, DTO, WebSocket 이벤트 변경 사항은 해당 문서의 변경 이력과 이 문서의 남은 작업/리스크 항목에 함께 반영해 추적한다.
