...
export function AppHeader({ notifications = 8 }: { notifications?: number }) {
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b border-slate-200 bg-white px-3 sm:h-16 sm:px-4 md:px-6">
      <div className="flex min-w-0 items-center gap-2 sm:gap-3">
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-2.5">
          ...
          <h1 className="min-w-0 truncate font-bold tracking-tight text-slate-900">
      ...
      <div className="flex shrink-0 items-center gap-0.5 sm:gap-1">
        <Button
          variant="ghost"
          size="icon"
          className="relative size-8 text-slate-600 hover:bg-slate-100 sm:size-9"
          aria-label="알림"
        >
        ...
        <div className="mx-0.5 h-5 w-px bg-slate-200 sm:mx-1 sm:h-6" />
        <Button
          variant="ghost"
          size="icon"
          className="size-8 text-slate-600 hover:bg-slate-100 sm:size-9"
          aria-label="사용자 메뉴"
        >
