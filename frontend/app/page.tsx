...
export default function DashboardPage() {
  ...
  const [selectedId, setSelectedId] = useState<string>(sorted[0]?.id ?? "DR-004")
        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-12">
          ...
          <section className="lg:col-span-6 xl:col-span-7">
            <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
              <h2 className="mb-4 text-base font-bold text-slate-900">도시 배수 시설 위험도 지도</h2>
              <RiskMap
                drains={DRAINS}
          ...
          <section className="lg:col-span-6 xl:col-span-5 2xl:col-span-3">
            <div className="h-full max-h-[640px] shadow-sm">
              <DrainRiskList drains={sorted} selectedId={selectedId} onSelect={setSelectedId} />
            </div>
          </section>
