      ...
      <div>
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="min-w-0">
            <p className="text-xs text-slate-500">시설명</p>
            <p className="text-sm font-semibold text-slate-900 [display:-webkit-box] [-webkit-box-orient:vertical] [-webkit-line-clamp:1] overflow-hidden">
              {drain.road}
            </p>
          </div>
        ...
        <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
          <div className="rounded-md bg-slate-50 px-2.5 py-2">
            <p className="text-slate-500">막힘</p>
            <p className="mt-0.5 font-semibold text-slate-800">
              {drain.blockage}%
            </p>
          </div>
          <div className="rounded-md bg-slate-50 px-2.5 py-2">
            <p className="text-slate-500">수위</p>
            <p className="mt-0.5 font-semibold text-slate-800">
              {drain.waterLevelPct}%
            </p>
          </div>
          <div className="rounded-md bg-slate-50 px-2.5 py-2">
            <p className="text-slate-500">유량</p>
            <p className="mt-0.5 font-semibold text-slate-800">
              {drain.flow} m³/min
            </p>
          </div>
...
function DashboardSummaryBar({ summary }: { summary: DashboardSummaryDto }) {
  ...
  return (
    <section className="mb-4 rounded-xl border border-slate-200 bg-white px-4 py-4 shadow-sm md:px-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0">
          <p className="text-sm font-bold text-slate-900">대시보드 현황</p>
...
function MapLoadingState() {
  return (
    <div className="flex min-h-[280px] items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50 px-4 text-center text-sm font-medium text-slate-400 sm:min-h-[320px] md:min-h-[420px]">
